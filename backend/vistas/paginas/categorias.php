...
<div class="form-check">
  <label class="form-check-label">
    <input class="checkbox" type="checkbox" class="ml-3" value="1 Plaza: para 1 persona,fas fa-user"> 
    <span class="badge badge-secondary"><i class="fas fa-user"></i> 1 Plaza (1 pers.) </span>
  </label>
</div>

<div class="form-check">
  <label class="form-check-label">
    <input class="checkbox" type="checkbox" class="ml-3" value="Matrimonial,fas fa-heart"> 
    <span class="badge badge-secondary"><i class="fas fa-heart"></i> Matrimonial </span>
  </label>
</div>

<div class="form-check">
  <label class="form-check-label">
    <input class="checkbox" type="checkbox" class="ml-3" value="Cama King: más grande que Queen,fas fa-crown"> 
    <span class="badge badge-secondary"><i class="fas fa-crown"></i> Cama King </span>
  </label>
</div>
          <div class="form-check">
            <label class="form-check-label">
...
<div class="form-check">
  <label class="form-check-label">
    <input class="checkbox" type="checkbox" class="ml-3" value="Baño compartido,fas fa-restroom"> 
    <span class="badge badge-secondary"><i class="fas fa-restroom"></i> Baño compartido </span>
  </label>
</div>
          <div class="form-check">
            <label class="form-check-label">
...
<div class="form-check">
  <label class="form-check-label">
    <input class="editarCheckbox" type="checkbox" class="ml-3" value="1 Plaza: para 1 persona,fas fa-user"> 
    <span class="badge badge-secondary"><i class="fas fa-user"></i> 1 Plaza (1 pers.) </span>
  </label>
</div>
...
<div class="form-check">
  <label class="form-check-label">
    <input class="editarCheckbox" type="checkbox" class="ml-3" value="Matrimonial,fas fa-heart"> 
    <span class="badge badge-secondary"><i class="fas fa-heart"></i> Matrimonial </span>
  </label>
</div>
...
<div class="form-check">
  <label class="form-check-label">
    <input class="editarCheckbox" type="checkbox" class="ml-3" value="Cama King: más grande que Queen,fas fa-crown"> 
    <span class="badge badge-secondary"><i class="fas fa-crown"></i> Cama King </span>
  </label>
</div>
          <div class="form-check">
          ...
          <div class="form-check">
  <label class="form-check-label">
    <input class="editarCheckbox" type="checkbox" class="ml-3" value="Baño compartido,fas fa-restroom"> 
    <span class="badge badge-secondary"><i class="fas fa-restroom"></i> Baño compartido </span>
  </label>
</div>
