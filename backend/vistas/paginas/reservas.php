          ...
          <div class="card card-info card-outline">
            ...
            <div class="card-body">
              ...
              <!--   <tr>
                  ...
                  <td>S/ <?php echo number_format(900000, 2, ",", "."); ?></td>
                  <td>19680828</td> 
                  <td>2019-10-17</td>
                  <td>2019-10-20</td>  
                  <td>
...
<div class="modal" id="modalAgregarReserva">
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      
      <div class="modal-header bg-primary">
        <h4 class="modal-title">Agregar Reserva Presencial</h4>
        <button type="button" class="close" data-dismiss="modal">&times;</button>
      </div>
      ...
      <div class="modal-body">
        ...
        <div class="row">
          ...
          <div class="col-6 form-group">
            ...
            <select class="form-control" id="nuevaCategoria" required>
              ...
              <?php
                // Llamamos al controlador para traer todas las categorías de tu_tabla_2
                $categorias = ControladorReservas::ctrMostrarCategorias();
          ...
          <div class="col-6 form-group">
            ...
            <select class="form-control" id="nuevaHabitacion" required disabled>
        ...
        <div class="row">
          <div class="col-6 form-group">
            ...
            <input type="text" class="form-control datepicker entradaNueva" placeholder="YYYY-MM-DD" autocomplete="off" required>
          </div>
          <div class="col-6 form-group">
            <label>Fecha de Salida</label>
            <input type="text" class="form-control datepicker salidaNueva" placeholder="YYYY-MM-DD" autocomplete="off" required>
          </div>
        </div>

        <div class="form-group">
          <label>Pago en Efectivo (S/)</label>
          <input type="number" step="0.01" class="form-control" id="nuevoPago" required>
        </div>
        
        <div class="form-group">
          <label>Descripción de la Reserva</label>
          <input type="text" class="form-control" id="nuevaDescripcion" placeholder="Ej: Pago presencial - 2 personas" required>
        </div>
      ...
      <div class="modal-footer d-flex justify-content-between">
        <button type="button" class="btn btn-danger" data-dismiss="modal">Cerrar</button>
        <button type="button" class="btn btn-primary btnGuardarReservaManual">Guardar Reserva</button>
      </div>
