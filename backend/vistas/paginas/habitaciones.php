...
$tipo        = $habitacion['tipo'] ?? 'Nueva habitación';
$estilo      = $habitacion['estilo'] ?? '';
$id_h        = $habitacion['id_h'] ?? '';
$video       = $habitacion['video'] ?? '';
$recorrido   = $habitacion['recorrido_virtual'] ?? '';
$descripcion = $habitacion['descripcion_h'] ?? '';

$galeria = [];
if (!empty($habitacion) && !empty($habitacion['galeria'])) {
        ...
        <div class="col-12 col-xl-7">
          ...
          <div class="card card-primary card-outline">
            ...
            <div class="card-header">
              ...
              <h5 class="card-title"><?php echo htmlspecialchars($tipo) ?> / <?php echo htmlspecialchars($estilo) ?></h5>
            ...
            <div class="card-body">
              ...
              <input type="hidden" class="idHabitacion" value="<?php echo htmlspecialchars($id_h) ?>">
