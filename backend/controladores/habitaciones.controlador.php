...
/*=============================================
    MOSTRAR MAPA AGRUPADO PARA LA VISTA
    =============================================*/
    static public function ctrMostrarMapaDisponibilidad(){
        $respuesta = ModeloHabitaciones::mdlMostrarDisponibilidadHoy();
        $habitacionesAgrupadas = array();
        foreach ($respuesta as $hab) {
            $habitacionesAgrupadas[$hab['categoria']][] = $hab;
        }
