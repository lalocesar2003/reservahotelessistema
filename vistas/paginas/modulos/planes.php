...
<div class="planes container-fluid bg-white p-0" id="planes">
	...
	<div class="container p-0">
		...
		<div class="grid-container">
			...
			<p class="text-muted text-left px-4 descripcionPlan" descripcionPlan="Te damos la bienvenida a Hospedaje Virgen del Carmen. Estamos encantados de ser tu elección para disfrutar de la tranquilidad y belleza de Huancabamba. Ofrecemos un alojamiento cómodo, económico y cercano a los principales puntos turísticos. ¡Esperamos que tu experiencia con nosotros sea inolvidable!">Te damos la bienvenida a Hospedaje Virgen del Carmen. Estamos encantados de ser tu elección para disfrutar de la tranquilidad y belleza de Huancabamba. Ofrecemos un alojamiento cómodo, económico y cercano a los principales puntos turísticos. ¡Esperamos que tu experiencia con nosotros sea inolvidable!</p>
