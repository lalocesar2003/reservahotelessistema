...
<div class="infoReservas container-fluid bg-white p-0 pb-5" idHabitacion="<?php echo $_POST["id-habitacion"]; ?>" fechaIngreso="<?php echo $_POST["fecha-ingreso"]; ?>" fechaSalida="<?php echo $_POST["fecha-salida"]; ?>" dias="<?php echo $dias; ?>">
    ...
    <option value="<?php echo $precioContinental; ?>,Plan Normal">
      Plan Normal S/<?php echo number_format($precioContinental); ?> 1 día 1 noche
    </option>
  </select>
				</div>
				...
				<div class="row py-4">
					...
					<div class="col-12 col-lg-6 col-xl-7 text-center text-lg-left">
						...
						<h1 class="precioReserva">S/<span><?php echo number_format($precioContinental*$dias);?></span> SOL</h1>
       			...
       			<?php foreach ($planes as $key => $value): ?>
					...
					<div class="col-12 col-md-6">
						...
						<figure class="center">
	       				...
	       				Temporada Baja: Plan Americano + S/ <?php echo number_format($value["precio_baja"]); ?> SOL<br>

	       				Temporada Alta: Plan Americano + S/ <?php echo number_format($value["precio_alta"]); ?> SOL
